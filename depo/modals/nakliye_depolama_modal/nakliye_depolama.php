...
if ($islem == "nakliyeci_depolama_hizmetleri_getir") {
    ?>
    <style>
        #nakliye_depolama_hizmeti_modal {
            overflow-y: scroll;
        }
    </style>
    <div class="modal fade" id="nakliye_depolama_hizmeti_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
        <div class="modal-dialog" style="width: 80%; max-width: 80%;">
            <div class="modal-content">
                <div class="modal-header text-white p-2">
                    <button type="button" class="btn-close btn-close-white" id="nakliye_depolama_hizmeti_modal_kapat"
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <select class="custom-select custom-select-sm" id="tasima_tipi">
                                                ...
                                                <option value="İHRACAT" selected>İHRACAT</option>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-danger btn-sm" id="nakliye_depolama_hizmeti_modal_kapat"><i
        ...
        <script>
            ...
            $("body").off("click", "#depo_konteyner_giris_kaydet_sql").on("click", "#depo_konteyner_giris_kaydet_sql", function () {
                ...
                if (depo_id == undefined || depo_id == "") {
                    ...
                    $.ajax({
                        url: "depo/controller/nakliye_controller/sql.php?islem=depo_konteyner_girisi_ekle_sql",
                        type: "POST",
                        data: {
                            tarih: tarih,
                            surucu_id: surucu_id,
                        ...
                        success: function (res) {
                            if (res == 1) {
                                Swal.fire(
                                    "Başarılı",
                                    "Depo Giriş Başarı İle Kaydedildi",
                                    "success"
                                );
                                $("#nakliye_depolama_hizmeti_modal").modal("hide");
            ...
            $(document).ready(function () {
                $("#nakliye_depolama_hizmeti_modal").modal("show");
            });

            $("body").off("click", "#nakliye_depolama_hizmeti_modal_kapat").on("click", "#nakliye_depolama_hizmeti_modal_kapat", function () {
                $("#nakliye_depolama_hizmeti_modal").modal("hide");
            })
...
if ($islem == "depo_carileri_getir") {
    ?>
    <div class="modal fade" id="depo_hizmetleri_icin_cari"
    ...
    <script>
        ...
        $("body").off("click", "#modal_kapat").on("click", "#modal_kapat", function () {
            $("#depo_hizmetleri_icin_cari").modal("hide");
        })
        ...
        $(document).ready(function () {
            ...
            $("#depo_hizmetleri_icin_cari").modal("show");
            ...
            table = $('#cari_listesi_arac_tanim').DataTable({
            ...
            $.get("konteyner/controller/arac_controller/sql.php?islem=carileri_getir", function (result) {
                if (result != 2) {
                    var json = JSON.parse(result);
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            ...
            $("#depo_cari_kodu").val(cari_kodu);
            $("#depo_cari_kodu").attr("data-id", id);
            $("#depo_cari_adi").val(cari_adi);
            $("#depo_hizmetleri_icin_cari").modal("hide");
        })
    </script>
    <?php
}
if ($islem == "nakliye_giris_carileri_getir") {
    ?>
    <div class="modal fade" id="depo_hizmetleri_cariler_modal"
    ...
    <script>
        ...
        $("body").off("click", "#modal_kapat").on("click", "#modal_kapat", function () {
            $("#depo_hizmetleri_cariler_modal").modal("hide");
        })
        ...
        $(document).ready(function () {
            ...
            $("#depo_hizmetleri_cariler_modal").modal("show");
            ...
            table = $('#cari_listesi_depo_giris').DataTable({
                scrollY: '35vh',
                scrollX: true,
                "info": false,
                "paging": false,
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            ...
            var cari_adi = $(this).find("td").eq(0).text();
            var cari_kodu = $(this).find("td").eq(1).text();
            $("#firma_kodu").val(cari_kodu);
            $("#firma_kodu").attr("data-id", id);
            $("#firma_adi").val(cari_adi.toUpperCase());
            $("#depo_hizmetleri_cariler_modal").modal("hide");
        })
    </script>
    <?php
