...
if ($islem == "satis_faturasi_olustur_modal") {
    ?>
    <div class="modal fade" id="depo_satis_faturasi_olustur_main_modal" data-backdrop="static"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="date" value="<?= date("Y-m-d") ?>"
                                               class="form-control form-control-sm  fatura_tarihi_satis_faturasi fatura_tarihi"
                                               id="fatura_tarihi">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 row mt-2 no-gutters">
                                        ...
                                        <div class="col-md-2 row">
                                            ...
                                            <button style="background-color: #F6FA70;width: 100% !important;"
                                                    class="btn btn-sm mx-5 mt-1" id="depo_kaydı_guncelle_satis"><i
                            ...
                            <div class="col-md-12 row">
                                <div class="col-8 mt-2">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-11">
                                        <textarea
                                                class="form-control form-control-sm aciklama_siparis aciklama_satis_faturasi_irsaliyeden_aktar "
                                                id="aciklama"
                                                cols="30"
                                                rows="10"></textarea>
                                        </div>
    ...
    <script>
        ...
        $("body").off("click", "#faturaya_ekle").on("click", "#faturaya_ekle", function () {
            ...
            if (faturaTarihi < irsaliyeTarihi) {
                ...
                if (cari_id == null || stok_id == null) {
                    ...
                    $.ajax({
                        url: "depo/controller/satis_controller/sql.php?islem=faturaya_urun_ekle_sql",
                        type: "POST",
                        data: {
        ...
        $(document).ready(function () {
            ...
            $("body").off("click", "#depo_kaydı_guncelle_satis").on("click", "#depo_kaydı_guncelle_satis", function () {
                ...
                if (fatura_tipi == 1) {
                    $.ajax({
                        url: "depo/controller/satis_controller/sql.php?islem=faturadaki_urunu_guncelle",
                        type: "POST",
                        data: {
                            stok_id: stok_id,
            ...
            $("body").off("click", ".fatura_urun_list").on("click", ".fatura_urun_list", function () {
                var id = $(this).attr("data-id");
                $.get("depo/controller/satis_controller/sql.php?islem=faturadaki_urunun_bilgilerini_getir", {id: id}, function (result) {
                    if (result != 2) {
                        $("#depo_kaydı_guncelle_satis").attr("data-id", id);
                        arr = [];
                        var item = JSON.parse(result);
            ...
            $("body").off("click", ".satis_fat_eksilt").on("click", ".satis_fat_eksilt", function () {
                ...
                if (fatura_turu == 1) {
                    $.ajax({
                        url: "depo/controller/satis_controller/sql.php?islem=muhtelif_faturdan_urunu_cikart",
                        type: "POST",
                        data: {
                            id: id,
                    ...
                    $.ajax({
                        url: "depo/controller/satis_controller/sql.php?islem=urunu_faturadan_cikart",
                        type: "POST",
                        data: {
                            id: id,
                            fatura_turu: "default",
                        ...
                        success: function (result) {
                            ...
                            if (result != 500) {
                                if (result == 2) {
                                    $("#depo_kaydı_guncelle_satis").prop("disabled", false);
                                    alis_table.clear().draw(false);
                                } else {
                                    const Toast = Swal.mixin({
                                        toast: true,
            ...
            $("#depo_satis_faturasi_olustur_main_modal").modal("show");
        ...
        $("body").off("click", "#fatura_olustur").on("click", "#fatura_olustur", function () {
            ...
            if (faturaTarihi < irsaliyeTarihi) {
                ...
                if (depo_id == "") {
                    ...
                    $.ajax({
                        url: "depo/controller/satis_controller/sql.php?islem=faturayi_kaydet_sql",
                        type: "POST",
                        data: {
                            cari_id: cari_id,
                            id: fatura_id,
                        ...
                        success: function (result) {
                            if (result != 2) {
                                if (result == 300) {
                                    ...
                                    $("#depo_satis_faturasi_olustur_main_modal").modal("hide");
                                }
                            } else {
                                Swal.fire(
                                    'Oops...',
        ...
        $("body").off("click", "#cariye_ait_irsaliyeler").on("click", "#cariye_ait_irsaliyeler", function () {
            ...
            if (cari_id == "" || cari_id == undefined) {
                ...
                $.get("depo/modals/satis_modal/satis_fatura_modal.php?islem=cariye_ait_irsaliyeleri_getir", {cari_id: cari_id}, function (getModal) {
...
if ($islem == "cariye_ait_irsaliyeleri_getir") {
    ...
    <div class="modal fade" data-backdrop="static" id="cariye_ait_irsaliyeler_modal"
        ...
        <div class="modal-dialog"
            ...
            <div class="modal-content">
                <div class="modal-header text-white p-2">Cariye Ait İşler Listesi
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.get("depo/controller/satis_controller/sql.php?islem=cariye_ait_irsaliyeler_getir_sql", {cari_id: "<?=$id?>"}, function (result) {
                if (result != 2) {
                    var json = JSON.parse(result);
                    let toplam_sayi = 0;
                    let toplam_tutar = 0;
                    json.forEach(function (item) {
                        irsaliye_table.row.add(["<input type='checkbox' class='col-9 depo_secilen_irsaliyeler' data-id='" + item.id + "'/>", item.hizmet_turu, item.siparis_tarihi, item.giris_tarihi, item.cikis_tarihi, item.konteyner_no, item.ucret, item.referans_no, item.epro_ref, item.beyanname_no]).draw(false);
                    })
        ...
        $("body").off("click", "#secilenleri_faturaya_aktar").on("click", "#secilenleri_faturaya_aktar", function () {
            ...
            $(".satis_irsaliyeden_aktar").each(function () {
                ...
                let kont_no = $(this).find("td").eq("5").text();
                let fiyat = $(this).find("td").eq(6).text();
                fiyat = parseFloat(fiyat.replace(/,/g, ''));
                let konteyner_no = $(this).find("td").eq(5).text();
                aciklama = kont_no + "\n";
            ...
            $(".aciklama_satis_faturasi_irsaliyeden_aktar ").val(aciklama);

            $.ajax({
                url: "depo/controller/satis_controller/sql.php?islem=aktarma_icin_satis_faturasi_olustur_sql",
                type: "POST",
                data: {
                    cari_id: "<?=$id?>"
                },
                success: function (response) {
                    if (response != 2) {
                        ...
                        $.ajax({
                            url: "depo/controller/satis_controller/sql.php?islem=secilen_irsaliyeyi_faturalastir",
                            type: "POST",
                            data: {
...
if ($islem == "satis_faturasi_guncelle_modal") {
    ?>
    <div class="modal fade" id="depo_satis_faturasi_guncelle_main_modal" data-backdrop="static"
         data-bs-keyboard="false" role="dialog">
    <div class="modal-dialog modal-sm"
         style="width: 100%; max-width: 100%;">
        <div class="modal-content">
            <div class="modal-header text-white p-2">
                <button type="button" class="btn-close btn-close-white modal_kapali_guncelle_button" id="modal_kapat"
                        aria-label="Close"></button>
            </div>
            <div class="page-content fade-in-up">
                <div class="ibox">
                    ...
                    <div class="modal-body" style="max-height: 75vh; overflow: auto;">
                                ...
                                <div class="card-body">
                                    <div class="col-12 row mt-2 no-gutters">
                                        ...
                                        <div class="col-md-2 row">
                                            ...
                                            <button style="background-color: #F6FA70;width: 100% !important;"
                                                    class="btn btn-sm mx-5 mt-2" id="depo_kaydı_guncelle_satis"><i
                                                        class="fa fa-refresh"></i> Kaydı Güncelle
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-danger modal_kapali_guncelle_button btn-sm"><i
                                        class="fa fa-close"></i> Vazgeç
                            </button>
                            <button class="btn btn-success btn-sm" id="fatura_guncelle_main_button"><i
                                        class="fa fa-plus"></i> Kaydet
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.get("depo/controller/satis_controller/sql.php?islem=satis_faturasi_ana_bilgilerini_getir_sql", {id: "<?=$_GET["id"]?>"}, function (res) {
                if (res != 2) {
            ...
            $.get("depo/controller/satis_controller/sql.php?islem=satis_urunlerini_getir_sql", {id: "<?=$_GET["id"]?>"}, function (res) {
                if (res) {
                    var json = JSON.parse(res);
                    json.forEach(function (item) {
                        let birim_fiyat = item.birim_fiyat;
            ...
            $("#depo_satis_faturasi_guncelle_main_modal").modal("show");
        ...
        $("body").off("click", "#fatura_guncelle_main_button").on("click", "#fatura_guncelle_main_button", function () {
            ...
            if (faturaTarihi < irsaliyeTarihi) {
                ...
                if (depo_id == "") {
                    ...
                    $.ajax({
                        url: "depo/controller/satis_controller/sql.php?islem=faturayi_guncelle_sql",
                        type: "POST",
                        data: {
                            cari_id: cari_id,
                            id: fatura_id,
                        ...
                        success: function (result) {
                            if (result != 2) {
                                if (result == 300) {
                                    ...
                                    $("#depo_satis_faturasi_guncelle_main_modal").modal("hide");
                                }
                            } else {
                                Swal.fire(
                                    'Oops...',
        ...
        $("body").off("click", ".modal_kapali_guncelle_button").on("click", ".modal_kapali_guncelle_button", function () {
