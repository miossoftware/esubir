...
<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>ALIŞ HİZMET LİSTESİ</div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("depo/controller/alis_controller/sql.php?islem=alis_hizmet_listesi_sql", function (res) {
            if (res != 2) {
