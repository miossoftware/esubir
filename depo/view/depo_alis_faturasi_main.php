...
<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>ALIŞ FATURALARI</div>
    </div>
    <div class="mx-2">
        <button class="btn btn-success btn-sm" id="depo_alis_faturasi_kes_button"><i class="fa fa-plus"></i>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("depo/controller/alis_controller/sql.php?islem=kesilen_faturalari_getir_sql", function (res) {
            if (res != 2) {
    ...
    $("body").off("click", ".depo_alis_fat_guncelle_button").on("click", ".depo_alis_fat_guncelle_button", function () {
        let id = $(this).attr("data-id");
        $.get("depo/modals/alis_modal/alis_fatura_modal.php?islem=alis_faturasi_guncelle_modal", {id: id}, function (getModal) {
            $(".getModals").html(getModal);
        })
    });

    $("body").off("click", ".depo_alis_faturasini_sil_button").on("click", ".depo_alis_faturasini_sil_button", function () {
    ...
    $("body").off("click", "#depo_alis_faturasi_kes_button").on("click", "#depo_alis_faturasi_kes_button", function () {
        $.get("depo/modals/alis_modal/alis_fatura_modal.php?islem=alis_faturasi_olustur_modal", function (getModal) {
            $(".getModals").html(getModal);
        })
    });
