...
<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>KALMAR TANIM</div>
    </div>
    <div class="col-12 row">
        <div class="mx-2">
            <button class="btn btn-success btn-sm" id="yeni_kalmar_ekle_button"><i class="fa fa-plus"></i>
                Kalmar Ekle
            </button>
...
<script>
    ...
    $("body").off("click", "#yeni_kalmar_ekle_button").on("click", "#yeni_kalmar_ekle_button", function () {
        $.get("depo/modals/tanimlar/kalmar_tanim_modal.php?islem=yeni_kalmar_tanit_main_modal", function (getModal) {
            $(".getModals").html(getModal);
        })
    });

    $("body").off("click", ".tanimli_kalmari_guncelle_button").on("click", ".tanimli_kalmari_guncelle_button", function () {
        let id = $(this).attr("data-id");
        $.get("depo/modals/tanimlar/kalmar_tanim_modal.php?islem=kalmar_tanim_guncelle_modal", {id: id}, function (getModal) {
            $(".getModals").html(getModal);
        })
    });
