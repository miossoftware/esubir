...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("depo/controller/is_emri_controller/sql.php?islem=kiralik_is_emirlerini_getir_sql", function (res) {
            if (res != 2) {
        ...
        $("body").off("click", ".is_emrini_guncelle_button").on("click", ".is_emrini_guncelle_button", function () {
            let id = $(this).attr("data-id");
            $.get("depo/modals/is_emri_modal/is_emri_olustur_modal.php?islem=depo_is_emri_guncelle_modal", {
                id: id,
                kiralik: "kiralik"
            }, function (getModal) {
        ...
        $("body").off("click", "#ithalat_is_emri_olustur").on("click", "#ithalat_is_emri_olustur", function () {
            $.get("depo/modals/is_emri_modal/is_emri_olustur_modal.php?islem=is_emri_olustur_ana_modal", {kiralik: "kiralik"}, function (getModal) {
                $(".getModals").html(getModal);
            })
        });
    });
