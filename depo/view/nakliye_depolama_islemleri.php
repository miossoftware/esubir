...
<div class="ibox mt-5">
    ...
    <div class="col-12 row">
        <div class="mx-2">
            <button class="btn btn-success btn-sm" id="depolama_hizmeti_ekle_button"><i class="fa fa-plus"></i> Depoya
                Giriş Ekle
            </button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("depo/controller/nakliye_controller/sql.php?islem=depodaki_konteynerleri_getir_sql", function (response) {
            if (response != 2) {
