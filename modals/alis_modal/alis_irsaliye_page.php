...
if ($islem == "irsaliye_icin_carileri_getir") {
            ...
            <div class="modal-content">
                ...
                <div class="ibox">
                    <div class="ibox-head" style='background-color:#9DB2BF'>
                        <div class="ibox-title" style='color:white; font-weight:bold;'>İRSALİYE EKLE</div>
                    </div>
    ...
    <script>
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            ...
            $("#cari_id").val(cari_adi);
            $("#cari_id").attr("data-id", id);
            ...
            $.get("controller/alis_controller/sql.php?islem=secilen_cari_bilgileri", {id: id}, function (result) {
                ...
                if (result != 2) {
                    ...
                    if (yetkiliAdi1 != null) {
                        ...
                        $(".yetkili_adi_irsaliye").val(yetkiliAdi1);
                    ...
                    if (vergiDairesi != "") {
                        ...
                        $(".vergi_daire_irsaliye").val(vergiDairesi);

                    }

                    $(".vergi_no_irsaliye").val(vergiNo);

                    $(".cari_adres_irsaliye").val(adres);
        ...
        $(document).ready(function () {
            ...
            $.get("controller/alis_controller/sql.php?islem=stok_listesi_getir", function (result) {
                ...
                if (result != 2) {
                    ...
                    var json = JSON.parse(result);
                    stok_table.rows.add(json).draw(false);
...
if ($islem == "olusan_irsaliye_goruntule_modal") {
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control form-control-sm alis_irsaliye_no"
                                           id="irsaliye_no">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.get("controller/alis_controller/sql.php?islem=secilen_irsaliye_bilgilerini_getir", {id: "<?=$_GET["id"]?>"}, function (result) {
            ...
            $.get("controller/alis_controller/sql.php?islem=irsaliye_urunlerini_getir", {irsaliye_id: "<?=$_GET["id"]?>"}, function (result) {
            ...
            $("body").off("click", ".irsaliye_selected").on("click", ".irsaliye_selected", function () {
                ...
                $.get("controller/alis_controller/sql.php?islem=siparisteki_urun_bilgileri", {id: id}, function (result) {
            ...
            $("body").off("click", "#irsaliye_kaydi_guncelle").on("click", "#irsaliye_kaydi_guncelle", function () {
                ...
                if (toplam_tutar < 0) {
                    ...
                    $.ajax({
                        ...
                        url: "controller/alis_controller/sql.php?islem=irsaliye_urun_guncelle",
        ...
        $("body").off("click", "#irsaliyeye_ekle").on("click", "#irsaliyeye_ekle", function () {
            ...
            if (cari_id == null || stok_id == null) {
                ...
                $.ajax({
                    ...
                    url: "controller/alis_controller/sql.php?islem=irsaliye_urun_ekle_sql",
        ...
        $("body").off("click", ".irsaliyeden_cikart").on("click", ".irsaliyeden_cikart", function () {
            ...
            $.ajax({
                ...
                url: "controller/alis_controller/sql.php?islem=irsaliyeden_urun_cikart",
        ...
        $("body").off("click", "#irsaliye_guncelle_ve_kaydet").on("click", "#irsaliye_guncelle_ve_kaydet", function () {
            ...
            var irsaliye_no = $(".alis_irsaliye_no").val();
            ...
            if (depo_id == "") {
                ...
                $.ajax({
                    url: "controller/alis_controller/sql.php?islem=irsaliyeyi_guncelle_sql",
                    type: "POST",
                    data: {
                        cari_id: cari_id,
