...
if ($islem == "irsaliye_ekle_modal") {
    ...
    <div class="modal fade" id="alis_irsaliye_modal" data-backdrop="static"
    ...
    $(this).select();
        ...
        $("body").off("click", "#cari_siparisleri").on("click", "#cari_siparisleri", function () {
            ...
            if (cari_id == "" || cari_id == null) {
                ...
                $.get("modals/alis_modal/irsaliye_modal.php?islem=cariye_ait_siparisleri_getir", {cari_id: cari_id}, function (getModal) {
        ...
        $(document).ready(function () {
            ...
            $("#alis_irsaliye_modal").modal("show");
        ...
        $("body").off("click", ".modal_kapali").on("click", ".modal_kapali", function () {
            ...
            if (silinecek_id != "") {
                ...
                $.ajax({
                    ...
                    url: "controller/alis_controller/sql.php?islem=irsaliye_iptal_et_sql",
                    ...
                    success: function (result) {
                        ...
                        if (result == 1) {
                            ...
                            $("#alis_irsaliye_modal").modal("hide");
...
if ($islem == "cariye_ait_siparisleri_getir") {
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.get("controller/alis_controller/sql.php?islem=cariye_ait_siparisleri_getir_sql", {cari_id: "<?=$id?>"}, function (result) {
        ...
        $("body").off("click", "#secilenleri_irsaliyeye_aktar").on("click", "#secilenleri_irsaliyeye_aktar", function () {
            ...
            $.ajax({
                ...
                url: "controller/alis_controller/sql.php?islem=secilen_siparisi_irsaliyelestir",
                ...
                success: function (result) {
                    ...
                    if (result != 2) {
                        ...
                        $.get("controller/alis_controller/sql.php?islem=secilen_irsaliye_bilgilerini_getir", {id: irsaliye_id}, function (result) {
