...
$islem = $_GET["islem"];
if ($islem == "yeni_siparis_olustur") {
    ?>
    <div class="modal fade" id="verilen_siparis_olustur_modal" data-backdrop="static"
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>SİPARİŞ VER</div>
                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <div class="input-group mb-3">
                                                <input type="text"
                                                       class="form-control form-control-sm siparis_secilen_cari"
                                        ...
                                        <div class="col-12 row mt-2 no-gutters">
                                            <div class="col-md-1">
                                                ...
                                                <div class="input-group">
                                                    <input type="text"
                                                           class="form-control form-control-sm stok_adi_siparis"
                                            ...
                                            <div class="col-md-1">
                                                <label style="font-weight: bold;font-size: 10px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tevkifat
                                                    Tutar</label>
                                                <input type="number" placeholder="Tevkifat Tutar"
                                        ...
                                        <div class="col-12 row no-gutters mt-2">
                                            ...
                                            <div class="col">
                                                <table class="table table-sm table-bordered w-100 display nowrap">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td class="doviz_ara_toplam_bas_siparis"
                                                            style="text-align: right">0,00 TL
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="doviz_kdv_toplam_bas_siparis"
                                                            style="text-align: right">0,00 TL
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="col">
                                                <table class="table table-sm table-bordered w-100 display nowrap">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td class="ara_toplam_bas_siparis" style="text-align: right">
                                                            0,00 TL
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="kdv_toplam_bas_siparis" style="text-align: right">
                                                            0,00 TL
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="tevkifat_tutari_bas_siparis"
                                                            style="text-align: right">0,00 TL
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="iskonto_toplam_bas_siparis"
                                                            style="text-align: right">0,00 TL
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="genel_toplam_bas_siparis" style="text-align: right">
                                                            0,00 TL
                                                        </td>
                                                    </tr>
                                                    </tbody>
    ...
    <script>
        ...
        $(".siparis_secilen_cari").keyup(function () {
            ...
            $.get("controller/alis_controller/sql.php?islem=girilen_cari_kodu_bilgileri", {cari_kodu: this_val}, function (result) {
                if (result != 2) {
                    var item = JSON.parse(result);
                    var cari_id = item.id;
                    $.get("controller/alis_controller/sql.php?islem=siparis_son_belge_no_cek", {cari_id: cari_id}, function (result) {
                        if (result != "") {
                            var item = JSON.parse(result);
        ...
        $("body").off("click", "#siparisi_olustur").on("click", "#siparisi_olustur", function () {
            ...
            if (depo_id == "") {
                ...
                $.ajax({
                    url: "controller/alis_controller/sql.php?islem=siparisi_guncelle_sql",
                    type: "POST",
                    data: {
                        cari_id: cari_id,
                    ...
                    success: function (result) {
                        if (result == 1) {
                            ...
                            $("#verilen_siparis_olustur_modal").modal("hide");
                        } else {
                            Swal.fire(
                                'Oops...',
        ...
        $("body").off("click", "#siparis_ekle_button").on("click", "#siparis_ekle_button", function () {
            ...
            if (cari_id == null || stok_id == null) {
                ...
                $.ajax({
                    url: "controller/alis_controller/sql.php?islem=siparis_urun_ekle_sql",
                    type: "POST",
                    data: {
                    ...
                    success: function (result) {
                        if (result != 1) {
                            ...
                            json.forEach(function (item) {
                                $("#siparis_ekle_button").attr("data-id", item.siparis_id);
        ...
        $("body").off("click", ".alis_urun_list").on("click", ".alis_urun_list", function () {
            ...
            $.get("controller/alis_controller/sql.php?islem=siparisteki_urun_bilgilerini_getir", {id: id}, function (result) {
                if (result != 2) {
                    $("#kaydi_guncelle_siparis").attr("data-id", id);
                    arr = [];
                    var item = JSON.parse(result);
        ...
        $("body").off("click", "#kaydi_guncelle_siparis").on("click", "#kaydi_guncelle_siparis", function () {
            var id = $(this).attr("data-id");
            ...
            $.ajax({
                url: "controller/alis_controller/sql.php?islem=siparis_urun_guncelle",
                type: "POST",
                data: {
                    stok_id: stok_id,
                    birim_id: birim_id,
                    ...
                    if (result != 500) {
                        if (result == 2) {
                            ...
                            json.forEach(function (item) {
                                ...
                                var siparis_id = siparis_table.row.add([item.stok_kodu, item.stok_adi, item.birim_adi, item.miktar, birim_fiyat + " TL", "%" + item.kdv_orani, kdv_fiyat + " TL", "%" + item.iskonto, iskonto_tutari + " TL", item.tevkifat_kodu, tevkifat_tutari + " TL", toplam_tutar + " TL", "<button class='btn btn-danger siparisden_cikart' data-id='" + item.id + "'><i class='fa fa-trash'></i></button>"]).draw(false).node();
                                $(siparis_id).attr("data-id", item.id);
                            });
                        }
                    } else {
                        const Toast = Swal.mixin({
        ...
        $(document).ready(function () {
            ...
            $("#verilen_siparis_olustur_modal").modal("show");
        ...
        $("body").off("click", ".modal_kapali").on("click", ".modal_kapali", function () {
            var silinecek_id = $("#siparis_ekle_button").attr("data-id");
            if (silinecek_id != "") {
                $.ajax({
                    url: "controller/alis_controller/sql.php?islem=siparisi_iptal_et_sql",
                    type: "POST",
                    data: {
                        id: silinecek_id
                    },
