...
$islem = $_GET["islem"];
if ($islem == "carileri_getir_siparis") {
    ?>
    ...
    <script>
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            ...
            $(".siparis_secilen_cari").val(cari_kodu);
            $(".cari_adi_siparis").val(cari_adi);
            $(".siparis_secilen_cari").attr("data-id", id);
            $("#siparis_cariler_listesi_modal").modal("hide");
            $.get("controller/alis_controller/sql.php?islem=secilen_cari_bilgileri", {id: id}, function (result) {
                if (result != 2) {
                    var item = JSON.parse(result);
                    $.get("controller/alis_controller/sql.php?islem=siparis_son_belge_no_cek", {cari_id: item.id}, function (result) {
                        if (result != "") {
                            var item = JSON.parse(result);
                    ...
                    if (yetkiliAdi1 != null) {
                        $(".cari_yetkili_adi").val(yetkiliAdi1);
                        $(".yetkili_cep_siparis").val(yetkiliTel1);
                    } else {
                        $(".cari_yetkili_adi").val(yetkiliAdi2);
                        $(".yetkili_cep_siparis").val(yetkiliTel2);
                    }
                    if (vergiDairesi != "") {
                        $(".siparis_vergi_daire").val(vergiDairesi);
                    }
                    $(".siparis_vergi_no").val(vergiNo);
                    $(".siparis_cari_adres").val(adres);
                }
            });
        })
    </script>
...
if ($islem == "siparis_guncelle_modal_getir") {
    ...
    <div class="modal fade" id="verilen_siparis_duzenle" data-backdrop="static"
         data-bs-keyboard="false" role="dialog">
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == 1) {
                            ...
                            $("#verilen_siparis_duzenle").modal("hide");
                        } else {
                            Swal.fire(
                                'Oops...',
        ...
        $.get("controller/alis_controller/sql.php?islem=secilen_siparis_bilgilerini_getir", {id: "<?=$id?>"}, function (result) {
            var item = JSON.parse(result);
            ...
            $.get("controller/alis_controller/sql.php?islem=secilen_cari_bilgileri", {id: item.cari_id}, function (result2) {
                ...
                $(".siparis_secilen_cari").val(item.cari_kodu);
        ...
        $.get("controller/alis_controller/sql.php?islem=siparisin_urunlerini_getir", {siparis_id: "<?=$id?>"}, function (result) {
            if (result != 2) {
                var json = JSON.parse(result);
        ...
        $(document).ready(function () {
            ...
            $("#verilen_siparis_duzenle").modal("show");
        ...
        $("body").off("change", "#doviz_tur").on("change", "#doviz_tur", function () {
            ...
            $.ajax({
                url: "controller/alis_controller/sql.php?islem=siparis_doviz_tur_degistir",
                type: "POST",
                data: {
                    doviz_tur: value,
                    id: id
