<div class="modal fade" id="anagrup_modal" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head" style='background-color:#9DB2BF'>
                        <div class="ibox-title" style='color:white; font-weight:bold;'>ANA GRUP TANIMLA</div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-success btn-sm" id="anagrup_ekle_button">Ana Grup Tanımla</button>
                </div>
            </div>
        </div>
    </div>
    <script>
        ...
        $("body").off("click", "#anagrup_ekle_button").on("click", "#anagrup_ekle_button", function () {
            ...
            $.ajax({
                url: "controller/anagrup_controller/sql.php?islem=yeni_ana_grup",
                type: "POST",
                data: {
