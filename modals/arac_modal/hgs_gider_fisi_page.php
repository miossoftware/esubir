...
if ($islem == "hgs_gider_fisi_detay_modal_getir") {
    ?>
    <style>
        #arac_hgs_gider_guncelle_main_modal {
            overflow-y: scroll;
        }
    </style>
    <div class="modal fade" id="arac_hgs_gider_guncelle_main_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>HGS GİDER FİŞİ</div>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="col-12 row">
                                ...
                                <div class="col-6">
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            <label>HGS / OGS No</label>
                                        </div>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm" id="hgs_ogs_no">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-4">
    ...
    <script>
        ...
        $("body").off("click", "#hgs_gider_kaydet_main_button").on("click", "#hgs_gider_kaydet_main_button", function () {
            ...
            $.ajax({
                url: "controller/arac_controller/sql.php?islem=hgs_gider_fisi_guncelle_sql",
                type: "POST",
                data: {
                    ...
                    if (response == 1) {
                        ...
                        $("#arac_hgs_gider_guncelle_main_modal").modal("hide");
        ...
        $("body").off("click", "#hgs_gider_fisi_kaydet").on("click", "#hgs_gider_fisi_kaydet", function () {
            ...
            if (plaka_id == "" || plaka_id == undefined) {
                ...
                $.ajax({
                    url: "controller/arac_controller/sql.php?islem=hgs_gider_fisi_ekle_sql",
                    type: "POST",
                    data: {
        ...
        $("body").off("click", ".hgs_gider_sil_list").on("click", ".hgs_gider_sil_list", function () {
            ...
            $.ajax({
                url: "controller/arac_controller/sql.php?islem=hgs_gider_fisi_sil_sql",
                type: "POST",
                data: {
                    id: id
                },
        ...
        $(document).ready(function () {
            ...
            $("#arac_hgs_gider_guncelle_main_modal").modal("show");
            ...
            $.get("controller/arac_controller/sql.php?islem=hgs_gider_fisi_bilgilerini_getir_sql", {gider_id: "<?=$_GET["id"]?>"}, function (response) {
                if (response != 2) {
