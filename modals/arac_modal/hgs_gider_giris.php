...
if ($islem == "hgs_gider_girisi_modal_getir") {
    ?>
    <style>
        #binek_arac_hgs_gider_modal {
            overflow-y: scroll;
        }
    </style>
    <div class="modal fade" id="binek_arac_hgs_gider_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
    ...
    <script>
        ...
        $("body").off("click", "#hgs_gider_kaydet_main_button").on("click", "#hgs_gider_kaydet_main_button", function () {
            ...
            $.ajax({
                url: "controller/arac_controller/sql.php?islem=hgs_gider_fisi_kaydet_sql",
                type: "POST",
                data: {
                ...
                success: function (result) {
                    if (result == 1) {
                        Swal.fire(
                            'Başarılı',
                            "HGS Gider Fişi Kaydedildi",
                            "success"
                        );
                        $("#binek_arac_hgs_gider_modal").modal("hide");
        ...
        $(document).ready(function () {
            $("#binek_arac_hgs_gider_modal").modal("show");
