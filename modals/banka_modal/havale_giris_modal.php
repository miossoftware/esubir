...
if ($islem == "yeni_havale_giris_ekle") {
    ?>
    <style>
    ...
    $('input').click(function() {
        ...
        $(document).ready(function () {
            ...
            table = $('#banka_havale_list').DataTable({
                ...
                createdRow: function (row) {
                    $(row).addClass("havale_giris_main_selected");
        ...
        $("body").off("click",".havale_giris_main_selected").on("click",".havale_giris_main_selected",function (){
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result == 1) {
                        ...
                        $(".havale_giris_main_selected").each(function () {
...
if ($islem == "cari_listesi_getir_modal") {
    ?>
    <div class="modal fade" id="banka_cari_listesi_getir_modal"
    ...
    <script>
        var cari_table = "";
        $(document).ready(function () {
            $("#banka_cari_listesi_getir_modal").modal("show");
            setTimeout(function () {
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            ...
            $("#masraf_cari").attr("data-id", id);
            $("#cari_adi").val(cari_adi);
            $("#cari_kodu_getir").val(cari_kodu);
            $("#masraf_cari").val(cari_adi);
            $("#tahsilat_tutar").focus();
            $("#banka_cari_listesi_getir_modal").modal("hide");
        })
