                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>Vadesine Göre Ödeme
                                Maddeleri
                            </div>
                        </div>
...
<!--                            </div>-->
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-secondary btn-sm" id="vadesine_gore_odeme_button"><i
    ...
    <script>
        ...
        $("body").off("click", "#vadesine_gore_odeme_button").on("click", "#vadesine_gore_odeme_button", function () {
            ...
            if (cari_gider_mi == 1){
                ...
                $.get("controller/cari_diger_controller/sql.php?islem=vadesine_gore_odeme_filtrele", {
                    ilk_vade: ilk_vade,
                    son_vade: son_vade,
                    ...
                    if (res != 2) {
                        ...
                        $.ajax({
                            url: "view/cari_vadesine_gore_odeme.php",
                            type: "POST",
                            data: {
                                data: jsonString
                            },
                        ...
                        Swal.fire(
                            "Uyarı",
                            "Belirlediğiniz Kriterlere Uygun Ödeme Bulunamadı",
                            "warning"
                        )
                    }
                })
