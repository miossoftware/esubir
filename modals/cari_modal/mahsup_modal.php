...
if ($islem == "yeni_mahsup_ekle_modal") {
    ?>
    <style>
    ...
    <div class="modal fade" id="cari_mahsup_fisi_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                    ...
                    <div class="ibox">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-12 row">
                                <label style="font-weight: bold;font-size: 13px">&nbsp;&nbsp;Mahsup Fiş
                                    Bilgileri</label>
                            ...
                            <div class="col-12 row mt-4 no-gutters">
                                ...
                                <div class="col-md-1 mx-3 mt-3">
                                    ...
                                    <input type="text" style="text-align: right"
                                           class="form-control form-control-sm mx-2 ust_borc" value="0,00"
                                           placeholder="Borç" id="">
                                </div>
                                <div class="col-md-1 mt-3">
                                    <label style="font-size: 10px; font-weight: bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Alacak</label>
                                    <input type="text" placeholder="Alacak" style="text-align: right"
                                           class="form-control form-control-sm mx-3 ust_alacak" value="0,00"
                                           id="mahsup_alacak">
                                </div>
                                <div class="col-md-2 mt-3">
                                    <label style="font-weight: bold;font-size: 10px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Açıklama</label>
                                ...
                                <div class="col-md-2 row mt-4 mx-3 mt-3">
                                    ...
                                    <button style="background-color: #F6FA70;width: 85% !important;"
                                            ...
                                            id="mahsup_fisi_guncelle_main"><i
                            ...
                            <div class="col-12 row no-gutters mt-3">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-danger btn-sm" id="mahsup_vazgec_cari"><i
                                                class="fa fa-close"></i>
                                        Vazgeç
                                    </button>
                                    <button class="btn btn-success btn-sm" id="mahsup_kaydet"><i class="fa fa-plus"></i>
                                        Kaydet
                                    </button>
                                </div>
                            </div>
    ...
    <script>
        ...
        $("body").off("click", "#mahsup_fisi_guncelle_main").on("click", "#mahsup_fisi_guncelle_main", function () {
            var doviz_turu = $("#doviz_tur_mahsup").val();
            var kur_fiyat = $("#doviz_kur_mahsup").val();
            var cari_id = $(".cari_kodu_getir").attr("data-id");
            var borc = $(".ust_borc").val();
        ...
        $("body").off("click", "#mahsup_vazgec_cari").on("click", "#mahsup_vazgec_cari", function () {
            var mahsup_id = $("#mahsup_fisi_ekle").attr("data-id");
            if (mahsup_id != undefined) {
                $.ajax({
                    url: "controller/cari_controller/sql.php?islem=cariyi_iptal_et_sql",
                    type: "POST",
                    data: {
                        mahsup_id: mahsup_id
                    },
...
if ($islem == "mahsup_icin_cari_getir") {
    ?>
    <div class="modal fade" id="fatura_cari_liste_modal_getir" role="dialog">
    ...
    <script>
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            ...
            let cari_kodu = $(this).find("td").eq(1).text();
            $.get("controller/alis_controller/sql.php?islem=secilen_cari_bilgileri", {
                id: id,
                cari_kodu: cari_kodu
            }, function (result) {
                if (result != 2) {
