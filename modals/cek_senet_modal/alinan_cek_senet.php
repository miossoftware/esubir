...
if ($islem == "yeni_alinan_cek_senet_olustur") {
    ?>
    <style>
        #yeni_alinan_cek_senet_olustur_modal {
            overflow-y: scroll;
        }
    </style>
    <div class="modal fade" id="yeni_alinan_cek_senet_olustur_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>ALINAN ÇEK GİRİŞ</div>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="col-12 row">
                                <table class="table table-sm table-bordered w-100 display nowrap"
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th style="text-align: right" class="cekler_toplami">0,00</th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                            ...
                            <div class="card-footer">
                                ...
                                <button class="btn btn-primary btn-sm" id="yeni_cek_girisi_olustur_button_modal"><i
                                            class="fa fa-plus"></i> Yeni Çek
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
            ...
            if (cek_id != "" || cek_id != undefined) {
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == 1) {
                            $("#yeni_alinan_cek_senet_olustur_modal").modal("hide");
                        } else {
                            $("#yeni_alinan_cek_senet_olustur_modal").modal("hide");
                        }
                    }
        ...
        $(document).ready(function () {
            ...
            $("#yeni_alinan_cek_senet_olustur_modal").modal("show");
        ...
        $("body").off("click", "#alinan_cek_girisi_onayla").on("click", "#alinan_cek_girisi_onayla", function () {
            ...
            let cari_kodu = $("#cek_senet_giris_cariid").val();
            ...
            if (cek_id != "" || cek_id != undefined) {
                $.ajax({
                    url: "controller/cek_senet_controller/sql.php?islem=cek_senet_onayla_sql",
                    type: "POST",
                    data: {
                        cari_id: cari_id,
                        tarih: tarih,
        ...
        $("body").off("click", ".cek_kaydi_guncelle_list_button").on("click", ".cek_kaydi_guncelle_list_button", function () {
            ...
            let cari_id = $("#cek_senet_giris_cariid").attr("data-id");
            let cek_id = $("#yeni_cek_girisi_olustur_button_modal").attr("data-id");
            $.get("modals/cek_senet_modal/alinan_cek_senet.php?islem=cek_senet_guncelle_modal", {
                cari_id: cari_id,
                id: id,
                cek_id: cek_id
            }, function (getModal) {
        ...
        $("body").off("click", ".cek_iptal_list_main").on("click", ".cek_iptal_list_main", function () {
            ...
            let cek_id = $("#yeni_cek_girisi_olustur_button_modal").attr("data-id");
            $.ajax({
                url: "controller/cek_senet_controller/sql.php?islem=cek_iptal_et_sql",
                type: "POST",
                data: {
                    id: id,
                    cek_id: cek_id
                ...
                success: function (result) {
                    ...
                    $(".cekler_toplami").html(toplam_tutar.toLocaleString("tr-TR", {
...
if ($islem == "yeni_cek_girisi_modal_getir") {
    ?>
    <div class="modal fade" id="yeni_cek_giris_modal_baslat" data-bs-keyboard="false"
         role="dialog">
        <div class="modal-dialog" style="width: 75%; max-width: 75%;">
            <div class="modal-content">
                <div class="modal-header text-white p-2">
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#yeni_cek_giris_modal_baslat").modal("show");
            let cari_adi = $("#cari_adi_cek_senet").val();
            $("#asil_borclu").val(cari_adi);
            $("#ciro_edilmis").val(cari_adi);
        });

        $("body").off("click", "#acilis_vazgec_cari").on("click", "#acilis_vazgec_cari", function () {
            $("#yeni_cek_giris_modal_baslat").modal("hide");
        })
        ...
        $("body").off("click", "#alinan_cek_girisi_kaydet").on("click", "#alinan_cek_girisi_kaydet", function () {
            ...
            $.ajax({
                url: "controller/cek_senet_controller/sql.php?islem=yeni_alinan_cek_girisi_sql",
                type: "POST",
                data: {
...
if ($islem == "cek_senet_guncelle_modal") {
    ?>
    <div class="modal fade" id="cek_guncelle_giris_modal_baslat" data-bs-keyboard="false"
         role="dialog">
        <div class="modal-dialog" style="width: 75%; max-width: 75%;">
            <div class="modal-content">
                <div class="modal-header text-white p-2">
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>ALINAN ÇEK GÜNCELLE</div>
                        </div>
                        <div class="modal-body">
                            <div class="col-12 row">
                                <div class="col-6">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.get("controller/cek_senet_controller/sql.php?islem=cek_bilgileri_getir_sql", {id: "<?=$_GET["id"]?>"}, function (result) {
                if (result != 2) {
                    var item = JSON.parse(result);
        ...
        $("body").off("click", "#alinan_cek_girisi_guncelle").on("click", "#alinan_cek_girisi_guncelle", function () {
            ...
            girilen_tutar = parseFloat(girilen_tutar);
            $.ajax({
                url: "controller/cek_senet_controller/sql.php?islem=yeni_alinan_cek_guncelle_sql",
                type: "POST",
                data: {
                    alinan_cekid: alinan_cekid,
                    ozel_kod: ozel_kod,
