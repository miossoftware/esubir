...
if ($islem == "cek_senet_guncelle_modal_getir") {
    ?>
    <style>
        #yeni_alinan_cek_senet_guncelle_main_modal {
            overflow-y: scroll;
        }
    </style>
    <div class="modal fade" id="yeni_alinan_cek_senet_guncelle_main_modal" data-backdrop="static"
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>ALINAN ÇEK SENET GÜNCELLE
                            </div>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="card-footer">
                                ...
                                <!--                                <button class="btn btn-success btn-sm" id="yeni_cek_girisi_olustur_button_modal" hidden><i-->
                                <!--                                        class="fa fa-check"></i>Kaydet-->
                                <!--                                </button>-->
                            </div>
                        </div>
    ...
    <script>
        ...
        $("body").off("click", "#cek_senet_vazgec_guncelle").on("click", "#cek_senet_vazgec_guncelle", function () {
            ...
            $("#yeni_alinan_cek_senet_guncelle_main_modal").modal("hide");
        })
        ...
        $(document).ready(function () {
            ...
            $("#yeni_alinan_cek_senet_guncelle_main_modal").modal("show");
            ...
            $.get("controller/cek_senet_controller/sql.php?islem=girilen_cek_senet_bilgileri_sql", {id: "<?=$_GET["id"]?>"}, function (result) {
                if (result != 2) {
        ...
        $.get("controller/cek_senet_controller/sql.php?islem=alinan_cek_ana_bilgiler_sql", {id: "<?=$_GET["id"]?>"}, function (result) {
            if (result != 2) {
                var item = JSON.parse(result);
