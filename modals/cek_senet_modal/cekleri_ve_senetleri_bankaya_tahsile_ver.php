...
if ($islem == "cekler_senetler_banka_tahsil") {
    ?>
    <div class="modal fade" id="cek_senet_banka_tahsil_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-12 row">
                                <table class="table table-sm table-bordered w-100 display nowrap"
                                       ...
                                       id="cek_senet_bankaya_tahsile_verme">
                                    <thead>
                                    <tr>
                            ...
                            <div class="card-footer">
                                ...
                                <button class="btn btn-info btn-sm" id="bankaya_tahsil_icin_liste_getir"><i
    ...
    <script>
        ...
        $("body").off("click","#cek_senet_vazgec_main").on("click","#cek_senet_vazgec_main",function (){
            $("#cek_senet_banka_tahsil_modal").modal("hide");
        });
        ...
        $(document).ready(function () {
            $("#cek_senet_banka_tahsil_modal").modal("show");
            ...
            tahsil_table = $('#cek_senet_bankaya_tahsile_verme').DataTable({
                scrollY: '30vh',
                scrollX: true,
                "info": false,
                bAutoWidth: false,
        ...
        $("body").off("click", "#bankaya_tahsil_icin_liste_getir").on("click", "#bankaya_tahsil_icin_liste_getir", function () {
            ...
            if (banka_id == "" || banka_id == undefined) {
                ...
                $.get("modals/cek_senet_modal/cekleri_ve_senetleri_bankaya_tahsile_ver.php?islem=cekler_seneter_listesi", function (getModal) {
        ...
        $("body").off("click","#alinan_cek_tahsile_ver_onayla").on("click","#alinan_cek_tahsile_ver_onayla",function (){
            ...
            $(".tahsil_edilecek_cek_senetler").each(function () {
                ...
                if (islem == "bankaya_tahsile_verme") {
        ...
        $("body").off("click", "#secilen_cekler_ve_senetleri_aktar").on("click", "#secilen_cekler_ve_senetleri_aktar", function () {
            ...
            if (hasSenetid == true && hasCekid == true) {
                ...
                arr.forEach(function (item) {
                    ...
                    $(table).attr("data-name", "bankaya_tahsile_verme");
