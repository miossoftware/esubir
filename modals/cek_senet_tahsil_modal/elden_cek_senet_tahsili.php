...
if ($islem == "elden_cek_senet_tahsili_getir_modal") {
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>ELDEN ÇEK TAHSİLİ
                            </div>
                        </div>
                        <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm" id="kasa_kodu_ceksenid">
                            ...
                            <div class="card-footer">
                                ...
                                <button class="btn btn-success btn-sm" id="elden_cek_senet_tahsil_kaydet"><i class="fa fa-check"></i> Kaydet</button>
                                <button class="btn btn-info btn-sm" id="elden_tahsil_icin_cek_senet_listesini_getir"><i class="fa fa-list"></i> Çek Listesi</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $("body").off("click","#elden_cek_senet_tahsil_kaydet").on("click","#elden_cek_senet_tahsil_kaydet",function (){
            var gidecek_arr = [];
            ...
            if (varmi == false) {
                ...
                let kasa_id = $("#kasa_kodu_ceksenid").attr("data-id");
                ...
                if (kasa_id == "" || kasa_id == undefined){
                    ...
                    $.ajax({
                        url: "controller/cek_senet_tahsil_odeme_controller/sql.php?islem=elden_tahsilati_gerceklestir_sql",
                        type: "POST",
                        data: {
                            tarih: tarih,
                            belge_no: belge_no,
        ...
        $("body").off("click","#elden_tahsil_icin_cek_senet_listesini_getir").on("click","#elden_tahsil_icin_cek_senet_listesini_getir",function (){
            $.get("modals/cek_senet_tahsil_modal/elden_cek_senet_tahsili.php?islem=tahsil_edilecek_cekleri_getir_modal", function (getModals) {
...
if ($islem == "tahsil_edilecek_cekleri_getir_modal") {
    ...
    <div class="modal fade" id="tahsile_verilen_cekler_ve_senetleri_getir"
        ...
        <div class="modal-dialog"
            ...
            <div class="modal-content">
                <div class="modal-header text-white p-2" style="font-weight: bold">Tahsile Verilne Çekler
    ...
    <script>
        $(document).ready(function () {
            ...
            $.get("controller/cek_senet_controller/sql.php?islem=cek_girislerini_getir_sql", function (result) {
                if (result != 2) {
