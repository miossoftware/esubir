...
if ($islem == "cek_senet_tahsil_et_modal") {
    ...
    <div class="modal fade" id="ilk_tahsil_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>TAHSİLE VERİLMİŞ ÇEK
                                TAHSİLİ
                            </div>
                        </div>
...
<!--                                            </div>-->
                            ...
                            <div class="card-footer">
                                <button class="btn btn-danger btn-sm" id="ilk_tahsil_modal_vazgec"><i class="fa fa-close"></i> Vazgeç</button>
    ...
    <script>
        ...
        $("body").off("click", "#secilen_cek_senetleri_tahsil_et").on("click", "#secilen_cek_senetleri_tahsil_et", function () {
            ...
            if (varmi == false) {
                ...
                $.ajax({
                    url: "controller/cek_senet_tahsil_odeme_controller/sql.php?islem=tahsilati_gerceklestir_sql",
                    type: "POST",
                    data: {
                        tarih: tarih,
                        belge_no: belge_no,
        ...
        $("body").off("click", ".tahsil_edilecek_cek_senet_sil").on("click", ".tahsil_edilecek_cek_senet_sil", function () {
        ...
        $("body").off("click", "#tahsile_verilen_tahsil_edilecek_cekler").on("click", "#tahsile_verilen_tahsil_edilecek_cekler", function () {
            $.get("modals/cek_senet_tahsil_modal/modal.php?islem=tahsil_edilecek_cekleri_getir_modal", function (getModals) {
...
if ($islem == "tahsil_edilecek_cekleri_getir_modal") {
    ...
    <script>
        $(document).ready(function () {
            ...
            $.get("controller/cek_senet_tahsil_odeme_controller/sql.php?islem=tahsile_verilen_cek_senetleri_getir", function (result) {
                if (result != 2) {
        ...
        $("body").off("click", "#secilen_tahsilleri_aktar").on("click", "#secilen_tahsilleri_aktar", function () {
            ...
            $(".tahsile_verilen_selected").each(function () {
                if ($(this).hasClass("tahsil_secildi")) {
                    ...
                    let secilenler = tahsile_verilen_tahsilat_main.row.add([seri_no, vade_tarih, asil_borclu, ciro_edilmis, tutar, keside_yeri, banka_adi, sube_adi, hesap_no, ozel_kod, "TAHSİL EDİLDİ", "MÜŞTERİNİN", "<button class='btn btn-danger btn-sm tahsil_edilecek_cek_senet_sil'><i class='fa fa-trash'></i></button>"]).draw(false).node();
