                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>TEMİNATA VERİLMİŞ ÇEK
                                TAHSİLİ
                            </div>
                        </div>
    ...
    <script>
        ...
        $("body").off("click", "#secilen_cek_senetleri_tahsil_et").on("click", "#secilen_cek_senetleri_tahsil_et", function () {
            ...
            if (varmi == false) {
                ...
                $.ajax({
                    url: "controller/cek_senet_tahsil_odeme_controller/sql.php?islem=teminata_verilen_tahsilati_gerceklestir_sql",
                    type: "POST",
                    data: {
                        tarih: tarih,
                        belge_no: belge_no,
        ...
        $("body").off("click", ".teminat_edilecek_cek_senet_sil").on("click", ".teminat_edilecek_cek_senet_sil", function () {
        ...
        $("body").off("click", "#tahsile_verilen_tahsil_edilecek_cekler").on("click", "#tahsile_verilen_tahsil_edilecek_cekler", function () {
            $.get("modals/cek_senet_tahsil_modal/teminata_verimis_cek_senet_tahsili.php?islem=tahsil_edilecek_cekleri_getir_modal", function (getModals) {
...
if ($islem == "tahsil_edilecek_cekleri_getir_modal") {
    ...
    <div class="modal fade" id="teminata_verilen_cekler_ve_senetleri_getir"
        ...
        <div class="modal-dialog"
            ...
            <div class="modal-content">
                <div class="modal-header text-white p-2" style="font-weight: bold">Teminata Verilne Çekler
    ...
    <script>
        $(document).ready(function () {
            ...
            $.get("controller/cek_senet_tahsil_odeme_controller/sql.php?islem=teminata_verilen_cek_senetleri_getir", function (result) {
                if (result != 2) {
        ...
        $("body").off("click", "#secilen_tahsilleri_aktar").on("click", "#secilen_tahsilleri_aktar", function () {
            ...
            $(".tahsile_verilen_selected").each(function () {
                if ($(this).hasClass("tahsil_secildi")) {
                    ...
                    let secilenler = tahsile_verilen_tahsilat_main.row.add([seri_no, vade_tarih, asil_borclu, ciro_edilmis, tutar, keside_yeri, banka_adi, sube_adi, hesap_no, ozel_kod, "TAHSİL EDİLDİ", "MÜŞTERİNİN", "<button class='btn btn-danger btn-sm teminat_edilecek_cek_senet_sil'><i class='fa fa-trash'></i></button>"]).draw(false).node();
