...
$islem = $_GET["islem"];
if ($islem == "yeni_kasa_odeme_fisi_modal") {
    ?>
    <div class="modal fade" id="kasa_odeme_ekle_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#kasa_odeme_ekle_modal").modal("show");
            ...
            $("body").off("click", "#tahsilat_vazgec").on("click", "#tahsilat_vazgec", function () {
                ...
                if (tahsilat_id != "") {
                    $.ajax({
                        url: 'controller/kasa_controller/sql.php?islem=odeme_iptal_et_sql',
                        type: "POST",
                        data: {
                            id: tahsilat_id
                        },
                        success: function (result) {
                            if (result == 1) {
                                $("#kasa_odeme_ekle_modal").modal("hide");
                            } else {
                                $("#kasa_odeme_ekle_modal").modal("hide");
                            }
                        }
