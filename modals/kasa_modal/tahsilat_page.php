...
if ($islem == "kasa_tahsilat_modal") {
    ?>
    <div class="modal fade" id="kasa_tahsilat_guncelle_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-12 row mt-2 no-gutters">
                            ...
                            <div class="col-md-1 mx-2">
                                ...
                                <input type="text" class="form-control form-control-sm" id="tahsilat_tutar"
                                       placeholder="Tutar">
                            </div>
                            <div class="col-md-2">
                                <label style="font-weight: bold;font-size: 10px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Açıklama</label>
    ...
    <script>
                    ...
                    success: function (result) {
                        if (result != 2) {
                            ...
                            json.forEach(function (item) {
                                ...
                                kur_fiyat = kur_fiyat.replace(/\./g, "").replace(",", ".");
                                kur_fiyat = parseFloat(kur_fiyat);
                                kur_fiyat = kur_fiyat.toLocaleString("tr-TR", {minimumFractionDigits: 2})
        ...
        $("body").off("click", "#tahsilat_vazgec").on("click", "#tahsilat_vazgec", function () {
            $("#kasa_tahsilat_guncelle_modal").modal("hide");
        });
        ...
        $(document).ready(function () {
            ...
            $("#kasa_tahsilat_guncelle_modal").modal("show");
            ...
            let ilk_tutar = 0;
            $.get("controller/kasa_controller/sql.php?islem=tahsilat_ust_bilgileri_getir_sql", {id: "<?=$_GET["id"]?>"}, function (result) {
                if (result != 2) {
                    var item = JSON.parse(result);
                    ...
                    ilk_tutar = item.tahsilat_toplam;
                }
            });
            ...
            $.get("controller/kasa_controller/sql.php?islem=urunleri_getir_sql", {id: "<?=$_GET["id"]?>"}, function (result) {
                if (result != 2) {
                    var json = JSON.parse(result);
                    json.forEach(function (item) {
                        var tutar = item.tutar;
