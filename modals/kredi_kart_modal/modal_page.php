...
if ($islem == "guncelle_modal_getir") {
    ?>
    <div class="modal fade" id="kredi_kart_guncelle_main_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>KREDİ KARTI GÜNCELLE</div>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="col-12 row">
                                <div class="col-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" id="kart_kodu" class="form-control form-control-sm" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-5">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm"
                                                   style="text-align: right" id="kart_limiti">
                                        </div>
                                    </div>
                                    <!--                                    <div class="form-group row">-->
                                    <!--                                        <div class="col-md-5">-->
                                    ...
                                    <!--                                                            id="cari_bilgileri_getir_kart_button"><i-->
                                    ...
                                    <!--                                        </div>-->
                                    <!--                                        <div class="col-md-7">-->
                                    <!--                                            <input type="text" class="form-control form-control-sm" id="kart_cari_adi"-->
                                    <!--                                                   disabled>-->
                                    <!--                                        </div>-->
                                    <!--                                    </div>-->
                                    <!--                                    <div class="form-group row">-->
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-success btn-sm" id="kart_tanim_guncelle"><i
                                            class="fa fa-check"></i>
                                    Kaydet
                                </button>
                            </div>
    ...
    <script>
        ...
        $("body").off("click", "#kart_tanim_guncelle").on("click", "#kart_tanim_guncelle", function () {
            ...
            $.ajax({
                url: "controller/kart_controller/sql.php?islem=kart_guncelle_sql",
                type: "POST",
                data: {
                    kart_adi: kart_adi,
                    kart_kodu: kart_kodu,
                ...
                success: function (result) {
                    if (result == 1) {
                        ...
                        $("#kredi_kart_guncelle_main_modal").modal("hide");
        ...
        $(document).ready(function () {
            $("#kredi_kart_guncelle_main_modal").modal("show");
        ...
        $.get("controller/kart_controller/sql.php?islem=secilen_kart_bilgilerini_getir_sql", {id: "<?=$_GET["id"]?>"}, function (response) {
            if (response != 2) {
                var item = JSON.parse(response);
                $("#kart_tanim_bankalar").val(item.banka_id);
                let vade_gun = item.hesap_kesim_gun;
                vade_gun = parseFloat(vade_gun);
                $("#kart_kodu").val(item.kart_kodu);
                $("#banka_adi").val(item.banka_adi);
                $("#sube_adi").val(item.sube_adi);
                let kart_limiti = item.kart_limiti;
                kart_limiti = parseFloat(kart_limiti);
                kart_limiti = kart_limiti.toLocaleString("tr-TR", {maximumFractionDigits: 2, minimumFractionDigits: 2});

                $("#kart_limiti").val(kart_limiti);
                vade_gun = vade_gun.toLocaleString("tr-TR", {minimumFractionDigits: 2, maximumFractionDigits: 2});
                $("#vade_gunu").val(vade_gun);
                $("#kart_cari_kodu").attr("data-id", item.cari_id);
                $("#kart_adi").val(item.kart_adi)
        ...
        $("body").off("click", "#cari_bilgileri_getir_kart_button").on("click", "#cari_bilgileri_getir_kart_button", function () {
            $.get("modals/kredi_kart_modal/modal.php?islem=kart_icin_carileri_getir", function (getModal) {
                $(".kredi_kart_icin_cari_getir_div_guncelle").html("");
                $(".kredi_kart_icin_cari_getir_div_guncelle").html(getModal);
            })
        });
