...
if ($islem == "yeni_kredi_kullan_modal") {
    ?>
    <style>
        #yeni_kredi_cekimi_olustur_modal {
            overflow-y: scroll;
        }
    </style>
    <div class="modal fade" id="yeni_kredi_cekimi_olustur_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
    ...
    <script>
        ...
        $("body").off("click", "#pos_cekim_islemini_kaydet").on("click", "#pos_cekim_islemini_kaydet", function () {
            ...
            if (pc_cari_kodu == undefined || pc_cari_kodu == "") {
                ...
                $.ajax({
                    url: "controller/kredi_controller/sql.php?islem=yeni_kredi_kullan_sql",
                    type: "POST",
                    data: {
        ...
        $(document).ready(function () {
            ...
            $("#yeni_kredi_cekimi_olustur_modal").modal("show");
