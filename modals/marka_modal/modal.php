...
session_start();
$islem = $_GET["islem"];
if ($islem == "marka_ekle_modal_getir") {
    ?>
    <div class="modal fade" id="marka_ekle_modal" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog">
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>YENİ MARKA EKLE</div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-success btn-sm" id="marka_kaydet">Kaydet</button>
                    </div>
                </div>
            </div>
        </div>
        <script>
            ...
            $("body").off("click", "#marka_kaydet").on("click", "#marka_kaydet", function () {
                ...
                $.ajax({
                    url: "controller/marka_controller/sql.php?islem=yeni_marka_ekle",
                    type: "POST",
                    data: {
                        marka_adi: marka_adi,
                        aciklama: aciklama
