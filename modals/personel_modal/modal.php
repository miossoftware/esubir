...
if ($islem == "yeni_personel_tanimla") {
    ?>
    <div class="modal fade" id="yeni_personel_tanimla_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                            ...
                            <div class="col-12 row">
                                <div class="col-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <select class="custom-select custom-select-sm" id="departman_id">
...
<!--                                    </div>-->
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-success btn-sm" id="personel_olustur"><i class="fa fa-check"></i> Kaydet</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#yeni_personel_tanimla_modal").modal("show");
        ...
        $("body").off("click","#personel_vazgec").on("click","#personel_vazgec",function (){
            $("#yeni_personel_tanimla_modal").modal("hide");
        })
        ...
        $("body").off("click","#personel_olustur").on("click","#personel_olustur",function (){
            // İLK TABLO
            ...
            if (bilanco_id == ""){
                ...
                $.ajax({
                    url:"controller/personel_controller/sql.php?islem=yeni_personel_ekle_sql",
                    type:"POST",
                    data:{
                        otomatik:otomatik,
