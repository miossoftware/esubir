...
if ($islem == "pos_hesap_tanimla_modal_getir") {
    ?>
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>POS TANIMLA</div>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-success btn-sm" id="pos_tanim_kaydet"><i class="fa fa-check"></i>
                                    Kaydet
                                </button>
                            </div>
                        </div>
    ...
    <script>
        ...
        $("body").off("click", "#pos_tanim_kaydet").on("click", "#pos_tanim_kaydet", function () {
            ...
            if (banka_id == "") {
                ...
                $.ajax({
                    url: "controller/pos_controller/sql.php?islem=yeni_pos_kaydet_sql",
                    type: "POST",
                    data: {
                        banka_id: banka_id,
                        vade_gunu: vade_gunu,
                    ...
                    success: function (result) {
                        if (result == 1) {
                            Swal.fire(
                                'Başarılı',
                                'POS Hesabı Başarıyla Oluşturuldu',
                                'success'
                            );
        ...
        $("body").off("click", "#cari_bilgileri_getir_pos_button").on("click", "#cari_bilgileri_getir_pos_button", function () {
            $.get("modals/pos_modal/modal.php?islem=pos_icin_carileri_getir", function (getModal) {
...
if ($islem == "pos_icin_carileri_getir") {
    ...
    <script>
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            ...
            $("#pos_cari_kodu").val(cari_kodu);
            $("#pos_cari_adi").val(cari_adi);
            $("#pos_cari_kodu").attr("data-id", id);
            $("#pos_cari_liste_modal_getir").modal("hide");
        })
    </script>
    <?php
