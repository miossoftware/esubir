...
if ($islem == "cariler_listesi_getir_modal") {
    ...
    <div class="modal fade" data-backdrop="static" id="fatura_cari_liste_modal_getir"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.get("controller/alis_controller/sql.php?islem=carileri_getir", function (result) {
                ...
                if (result != 2) {
                    ...
                    //
                    //     var cari_table = table.row.add([item.cari_adi, item.cari_kodu]).draw(false).node();
                    //
                    //     $(cari_table).attr("data-id", item.id);
                    //
                    //     $(cari_table).find('td').eq(0).css('text-align', 'left');
                    //
                    //     $(cari_table).find('td').eq(1).css('text-align', 'left');
                    //
                    // });
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            $.get("controller/satis_controller/sql.php?islem=satis_fatura_son_belge", function (result) {
                $(".main_fatura_no").val(result)
            });
...
if ($islem == "faturayi_goruntule_ve_guncelle") {
    ...
    <div class="modal fade" id="satis_faturayi_goruntule_modal" data-backdrop="static"
                        ...
                        <div class="col-md-12 row ana_fatura">
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control form-control-sm cari_adi sectin_cari_adi" disabled>
                                    </div>
                                </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control form-control-sm satis_fatura_no main_fatura_no"
                                               id="fatura_no">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 row no-gutters">
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="custom-select custom-select-sm satis_doviz_tur"
                                                    id="doviz_tur">
...
<!--                                </div>-->
                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="col-8 mt-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <textarea class="form-control form-control-sm aciklama_ekle" id="aciklama"
                                                  cols="30"
    ...
    <script>
        ...
        $("body").off("click", ".alis_modal_kapat").on("click", ".alis_modal_kapat", function () {
            ...
            $("#satis_faturayi_goruntule_modal").modal("hide");
        ...
        $(document).ready(function () {
            ...
            let ilk_tutar = 0;
            $.get("controller/satis_controller/sql.php?islem=fatura_ana_bilgileri_getir", {id: "<?=$id?>"}, function (result) {

                var item = JSON.parse(result);
                ilk_tutar = item.genel_toplam;
                $(".aciklama_ekle").val(item.aciklama);
                ...
                $.get("controller/alis_controller/sql.php?islem=secilen_cari_bilgileri", {id: item.cari_id}, function (result2) {
                    ...
                    if (item.yetkili_adi1 != null) {
                        ...
                        $(".yetkili_adi").val((item.yetkili_adi1));

                        $(".yetkili_cep").val(item.yetkili_tel1);

                    } else {

                        $(".yetkili_adi").val((item.yetkili_ad2));
                ...
                $(".satis_fatura_no").val(item.fatura_no);
                ...
                var irsaliyeTarih = item.irsaliye_tarih;

                var explode2 = irsaliyeTarih.split(" ");

                var irsaliye_tarihi = explode2[0];


                var vadeTarihi = item.vade_tarihi;

                var explode3 = vadeTarihi.split(" ");

                var vade_tarihi = explode3[0];
                ...
                setTimeout(function () {
                    ...
                    $(".satis_doviz_tur").val(item.doviz_tur);
            ...
            $.get("controller/satis_controller/sql.php?islem=faturanini_urunlerini_getir", {satis_defaultid: "<?=$id?>"}, function (result) {
            ...
            $("#satis_faturayi_goruntule_modal").modal("show");
            ...
            $("#doviz_kuru").focusout(function () {
                ...
                $.ajax({
                    ...
                    url: "controller/satis_controller/sql.php?islem=doviz_kur_guncelle_sql",
            ...
            $("body").off("change", "#doviz_tur").on("change", "#doviz_tur", function () {
                ...
                if ($("#fatura_tipi").val() == "") {
                    ...
                    $.ajax({
                        ...
                        url: "controller/satis_controller/sql.php?islem=doviz_kur_degistir",
            ...
            $("body").off("click", ".satis_faturasindan_eksilt_guncelle").on("click", ".satis_faturasindan_eksilt_guncelle", function () {
                ...
                if (result != 2) {
                    ...
                    json.forEach(function (item) {
                        ...
                        $("#depo_id").append("" +
                            ...
                            "<option value='" + item.id + "'>" + depo_adi + "</option>" +
