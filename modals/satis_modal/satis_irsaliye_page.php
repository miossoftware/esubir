...
if ($islem == "irsaliye_icin_carileri_getir") {

    ?>

    <div class="modal fade" data-backdrop="static" id="irsaliye_cari_liste_modal_getir"
    ...
    <script>
        ...
        $("body").off("click", "#modal_kapat").on("click", "#modal_kapat", function () {
            ...
            $("#irsaliye_cari_liste_modal_getir").modal("hide");
        ...
        $(document).ready(function () {
            ...
            $("#irsaliye_cari_liste_modal_getir").modal("show");
        ...
        $("body").off("click", ".cari_select").on("click", ".cari_select", function () {
            ...
            $(".secilen_cari_irsaliye").val(cari_kodu);

            $(".secilen_cari_irsaliye").attr("data-id", id);
...
if ($islem == "irsaliye_stok_getir_modal") {

    ?>

    <div class="modal fade" data-backdrop="static" id="irsaliye_stok_getir_modal"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#irsaliye_stok_getir_modal").modal("show");
            ...
            $("body").off("click", ".stock_select").on("click", ".stock_select", function () {
                ...
                $("#irsaliye_stok_getir_modal").modal("hide");
...
if ($islem == "olusan_irsaliye_goruntule_modal") {

    $id = $_GET["id"];

    ?>

    <div class="modal fade" id="alis_irsaliye_goruntule_modal" data-backdrop="static"
    ...
    <div class="modal-dialog modal-sm"
        ...
        <div class="modal-content">
            ...
            <div class="modal-header text-white p-2">Alış İrsaliye
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head" style='background-color:#9DB2BF'>
                        <div class="ibox-title" style='color:white; font-weight:bold;'>ALIŞ İRSALİYE</div>
                    </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text"
                                                   class="form-control form-control-sm secilen_cari_irsaliye"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control form-control-sm vergi_no_irsaliye"
                                               disabled>
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control form-control-sm son_irsaliye"
                                               id="irsaliye_no">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-12 row mt-2 no-gutters">
                                        ...
                                        <div class="col-md-2 row">
                                            ...
                                            <input type="hidden" id="irsaliye_id_modala_ait" value="<?= $_GET["id"] ?>">

                                            <button style="width: 100% !important;"

                                                    class="btn btn-success btn-sm mx-5" id="irsaliyeye_ekle"
                                        ...
                                        <div class="col">
                                            ...
                                            <table class="table table-sm table-bordered w-100 display nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="doviz_tevkifat_tutar_irsaliye" style="text-align: right">
                                                        0,00
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="doviz_iskonto_irsaliye" style="text-align: right">0,00 TL
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="doviz_genel_toplam_irsaliye" style="text-align: right">0,00
                                                        TL
                                        ...
                                        <div class="col">
                                            ...
                                            <table class="table table-sm table-bordered w-100 display nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ara_toplam_bas_irsaliye" style="text-align: right">0,00
                                                        TL
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="kdv_toplam_bas_irsaliye" style="text-align: right">0,00
                                                        TL
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tevkifat_tutari_bas_irsaliye" style="text-align: right">
                                                        0,00
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="iskonto_toplam_bas_irsaliye" style="text-align: right">
                                                        0,00
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.get("controller/satis_controller/sql.php?islem=secilen_irsaliye_bilgilerini_getir", {id: "<?=$_GET["id"]?>"}, function (result) {
                ...
                $.get("controller/alis_controller/sql.php?islem=secilen_cari_bilgileri", {id: item.cari_id}, function (result2) {
                    ...
                    $("#irsaliyeye_ekle").attr("data-id", item.id);
                ...
                var siparisTarihi = item.irsaliye_tarihi;
                ...
                $("#irsaliye_tarih").val(siparis_tarihi)
            ...
            $.get("controller/satis_controller/sql.php?islem=irsaliye_urunlerini_getir", {irsaliye_id: "<?=$_GET["id"]?>"}, function (result) {
            ...
            $("#alis_irsaliye_goruntule_modal").modal("show");
        ...
        $("body").off("click", "#irsaliyeye_ekle").on("click", "#irsaliyeye_ekle", function () {
            ...
            var irsaliye_id = $("#irsaliye_id_modala_ait").val();
        ...
        $("body").off("click", ".modal_kapali").on("click", ".modal_kapali", function () {
            ...
            $("#alis_irsaliye_goruntule_modal").modal("hide");
