...
if ($islem == "elden_cek_senet_tahsili_getir_modal") {
    ?>
    <style>
        #ucuncu_tahsil_modal {
            overflow-y: scroll;
    ...
    <div class="modal fade" id="ucuncu_tahsil_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
        <div class="modal-dialog" style="width: 75%; max-width: 75%;">
            <div class="modal-content">
                <div class="modal-header text-white p-2">
                    <button type="button" class="btn-close btn-close-white" id="ucuncu_tahsil_modal_vazgec"
                            aria-label="Close"></button>
                </div>
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>ELDEN SENET TAHSİLİ
                            </div>
                        </div>
                        <div class="modal-body">
                            <div class="tahsil_edilecekleri_getir_div"></div>
                            <div class="kasalari_getir_div"></div>
                            <div class="col-12 row">
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm kasa_senetid" id="kasa_kodu_ceksenid">
                                                <div class="input-group-append">
                                                    <button class="btn btn-warning btn-sm" id="kasalari_getir_button"><i
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm" id="kasa_adi_ceksenetid" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-7">
                                            <input type="date" id="tarih_tahsilat" class="form-control form-control-sm"
                                                   value="<?= date("Y-m-d") ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" id="belge_no_tahsilat" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" id="ozel_kod1_tahsilat" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-7">
                                            <select class="custom-select custom-select-sm" id="doviz_tur_cek_senet_tahsilat">
                                ...
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <textarea class="form-control form-control-sm" id="aciklama_cek_senet_tahsilat" style="resize: none"
                                                      rows="6"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <table class="table table-sm table-bordered w-100 display nowrap"
                                       ...
                                       id="elden_cek_senet_tahsili_list">
                                    <thead>
                                    <tr>
                            ...
                            <div class="card-footer">
                                <button class="btn btn-danger btn-sm" id="ucuncu_tahsil_modal_vazgec"><i class="fa fa-close"></i> Vazgeç</button>
                                <button class="btn btn-success btn-sm" id="elden_senet_tahsili_kaydet_list_button"><i class="fa fa-check"></i> Kaydet</button>
                                <button class="btn btn-info btn-sm" id="elden_tahsil_icin_cek_senet_listesini_getir"><i class="fa fa-list"></i> Senet Listesi</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $("body").off("click","#elden_senet_tahsili_kaydet_list_button").on("click","#elden_senet_tahsili_kaydet_list_button",function (){
            var gidecek_arr = [];
            var firstTrDataId = tahsile_verilen_tahsilat_main.row(':eq(0)').data()[6];
            let varmi = false;
            $(".secilen_elden_cek_senet_tahsil").each(function () {
            ...
            if (varmi == false) {
                ...
                let kasa_id = $(".kasa_senetid").attr("data-id");
                ...
                if (kasa_id == "" || kasa_id == undefined){
                    Swal.fire(
                        'Uyarı!',
                        'Lütfen Bir Kasa Seçiniz...',
                        'warning'
                    );
                }else {
                    $.ajax({
                        url: "controller/senet_controller/sql.php?islem=elden_tahsilati_gerceklestir_sql",
                        type: "POST",
                        data: {
                            tarih: tarih,
                            belge_no: belge_no,
                        ...
                        success: function (result) {
                            if (result == 1) {
                                ...
                                $("#ucuncu_tahsil_modal").modal("hide");
        ...
        $("#kasa_kodu_ceksenid").keyup(function (){
            let val = $(this).val();
            $.get("controller/cek_senet_controller/sql.php?islem=kasa_kodu_bilgileri_getir",{banka_kodu:val},function (result){
                if (result != 2) {
                    ...
                    $("#kasa_kodu_ceksenid").attr("data-id", "");
                    $("#kasa_adi_ceksenetid").val("");
                }
            })
        })

        $("body").off("click","#elden_tahsil_icin_cek_senet_listesini_getir").on("click","#elden_tahsil_icin_cek_senet_listesini_getir",function (){
            $.get("modals/senet_tahsil/elden_senet_tahsili.php?islem=tahsil_edilecek_cekleri_getir_modal", function (getModals) {
                $(".tahsil_edilecekleri_getir_div").html("");
                $(".tahsil_edilecekleri_getir_div").html(getModals);
            })
        });

        $("body").off("click","#kasalari_getir_button").on("click","#kasalari_getir_button",function (){
            $.get("modals/cek_senet_modal/another_modal.php?islem=kasalar_listesi_modal",function (getModal){
                $(".kasalari_getir_div").html("");
                $(".kasalari_getir_div").html(getModal);
            })
        });

        $("body").off("click", "#ucuncu_tahsil_modal_vazgec").on("click", "#ucuncu_tahsil_modal_vazgec", function () {
            $("#ucuncu_tahsil_modal").modal("hide");
        });
        var tahsile_verilen_tahsilat_main = "";
        $(document).ready(function () {
            $("#ucuncu_tahsil_modal").modal("show");
            tahsile_verilen_tahsilat_main = $('#elden_cek_senet_tahsili_list').DataTable({
                scrollY: '30vh',
                scrollX: true,
                "info": false,
                bAutoWidth: false,
                ...
                createdRow: function (row) {
                    $(row).addClass("secilen_elden_cek_senet_tahsil");
        ...
        $("body").off("click",".elden_tahsil_edilecek_cek_senetleri_sil").on("click",".elden_tahsil_edilecek_cek_senetleri_sil",function (){
...
if ($islem == "tahsil_edilecek_cekleri_getir_modal") {
    ...
    <div class="modal fade" id="tahsile_verilen_cekler_ve_senetleri_getir"
        ...
        <div class="modal-dialog"
            ...
            <div class="modal-content">
                <div class="modal-header text-white p-2" style="font-weight: bold">Tahsile Verilen Senetler
    ...
    <script>
        $(document).ready(function () {
            ...
            $.get("controller/senet_controller/sql.php?islem=cek_girislerini_getir_sql", function (result) {
                if (result != 2) {
                    ...
                    json.forEach(function (item) {
                        ...
                        let table = cek_senet_tahsildekiler_main.row.add(["<input type='checkbox' class='col-9 secilen_tahsillikler' data-id='" + item.id + "'>", item.seri_no, vade_tarih, item.asil_borclu, item.ciro_edilmis, tutar, item.keside_yeri, item.banka_adi, item.banka_sube, item.hesap_no, item.ozel_kod]).draw(false).node();
        ...
        $("body").off("click", "#secilen_tahsilleri_aktar").on("click", "#secilen_tahsilleri_aktar", function () {
            ...
            $(".tahsile_verilen_selected").each(function () {
                if ($(this).hasClass("tahsil_secildi")) {
                    ...
                    let secilenler = tahsile_verilen_tahsilat_main.row.add([seri_no, vade_tarih, asil_borclu, ciro_edilmis, tutar, keside_yeri, banka_adi, sube_adi, hesap_no, ozel_kod, "TAHSİL EDİLDİ", "MÜŞTERİNİN", "<button class='btn btn-danger btn-sm elden_tahsil_edilecek_cek_senetleri_sil'><i class='fa fa-trash'></i></button>"]).draw(false).node();
