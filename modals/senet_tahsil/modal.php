...
if ($islem == "senet_tahsil_et_modal_getir") {
    ?>
    <style>
        #tahsile_verilmis_senet_tahsili_modal {
            overflow-y: scroll;
        }
    </style>
    <div class="modal fade" id="tahsile_verilmis_senet_tahsili_modal" data-backdrop="static" data-bs-keyboard="false"
         role="dialog">
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>TAHSİLE VERİLMİŞ SENET TAHSİLİ</div>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="card-footer">
                                ...
                                <button class="btn btn-info btn-sm" id="tahsile_verilen_tahsil_edilecek_senetler"><i
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#tahsile_verilmis_senet_tahsili_modal").modal("show");
        ...
        $("body").off("click", "#secilen_cek_senetleri_tahsil_et").on("click", "#secilen_cek_senetleri_tahsil_et", function () {
            ...
            if (varmi == false) {
                ...
                $.ajax({
                    url: "controller/senet_controller/sql.php?islem=tahsilati_gerceklestir_sql",
                    type: "POST",
                    data: {
                        tarih: tarih,
                        belge_no: belge_no,
                    ...
                    success: function (result) {
                        if (result == 1) {
                            ...
                            $("#tahsile_verilmis_senet_tahsili_modal").modal("hide");
...
if ($islem == "tahsil_edilecek_cekleri_getir_modal") {
    ...
    <script>
        $(document).ready(function () {
            ...
            $.get("controller/senet_controller/sql.php?islem=tahsile_verilen_cek_senetleri_getir", function (result) {
                if (result != 2) {
