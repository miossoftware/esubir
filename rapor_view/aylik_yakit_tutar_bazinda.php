...
<div class="ibox-container">
    <div class="ibox mt-5">
        <div class="ibox-head">
            <div class="ibox-title" style=' font-weight:bold;'>AYLIK YAKITLAR TUTAR BAZINDA</div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("konteyner/controller/yakit_controller/sql.php?islem=aylik_tutar_bazinda_yakitlari_getir_sql",function (res){
            if (res != 2){
