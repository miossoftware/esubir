...
<div class="ibox-container">
    <div class="ibox mt-5">
        <div class="ibox-head">
            <div class="ibox-title" style=' font-weight:bold;'>TOPLAM YAKIT GİDERLERİ SÜRÜCÜ BAZINDA</div>
        </div>
        <div class="row no-gutters">
            ...
            <div class="col-1 mx-3">
                <button class="btn btn-secondary btn-sm" id="toplam_yakit_giderleri_surucu_button"><i class="fa fa-filter"></i>
                    Hazırla
                </button>
            </div>
        </div>
        <div class="col-12 row mt-4">
            <table class="table table-sm table-bordered nowrap" style="cursor:pointer;font-size: 13px;"
                ...
                <tr>
                    ...
                    <th style="width: 0% !important;">Sürücü Adı</th>
                    <th>Bölge</th>
                    <th>Araç Tipi</th>
                    <th>Marka</th>
                    <th>İlk KM</th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("konteyner/controller/yakit_controller/sql.php?islem=aylik_surucu_bazinda_toplam_hareketler", function (res) {
            if (res != 2) {
        ...
        $("body").off("click", "#toplam_yakit_giderleri_surucu_button").on("click", "#toplam_yakit_giderleri_surucu_button", function () {
            let bas_tarih = $("#bas_tarih").val();
            let bit_tarih = $("#bit_tarih").val();
            $.get("konteyner/controller/yakit_controller/sql.php?islem=aylik_surucu_bazinda_toplam_hareketler", {
                bas_tarih: bas_tarih,
                bit_tarih: bit_tarih
            }, function (res) {
                if (res != 2) {
