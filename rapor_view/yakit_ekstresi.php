...
<div class="ibox-container">
    <div class="ibox mt-5">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-1 mx-1">
                <select class="custom-select custom-select-sm" id="arac_grubu">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("konteyner/controller/yakit_controller/sql.php?islem=yakit_hareketlerini_getir_sql", function (res) {
            if (res != 2) {
        ...
        $("body").off("click", "#yakit_ekstre_filtrele").on("click", "#yakit_ekstre_filtrele", function () {
            ...
            $.get("konteyner/controller/yakit_controller/sql.php?islem=yakit_hareketlerini_getir_sql", {
                bas_tarih: bas_tarih,
