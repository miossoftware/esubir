<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>DÖVİZ ALIM</div>
    </div>
    <div class="col-12 row">
        <div class="mx-2">
            <button class="btn btn-success btn-sm" id="doviz_alim_yap_button"><i class="fa fa-plus"></i> Alım Yap
            </button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("controller/banka_controller/sql.php?islem=doviz_alimlari_getir_sql", function (res) {
            if (res != 2) {
        ...
        $("body").off("click", ".doviz_alim_guncelle_button").on("click", ".doviz_alim_guncelle_button", function () {
            let id = $(this).attr("data-id");
            $.get("modals/banka_modal/doviz_alim_modal.php?islem=doviz_alim_guncelle_modal", {id: id}, function (getModal) {
    ...
    $("body").off("click", ".doviz_alim_sil_button").on("click", ".doviz_alim_sil_button", function () {
        ...
        if (id == "" || id == undefined) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "controller/banka_controller/sql.php?islem=doviz_alim_sil_sql",
                        type: "POST",
                        data: {
                            id: id,
    ...
    $("body").off("click", "#doviz_alim_yap_button").on("click", "#doviz_alim_yap_button", function () {
        $.get("modals/banka_modal/doviz_alim_modal.php?islem=yeni_doviz_alim_yap_modal", function (getModal) {
            $(".getModals").html("");
            $(".getModals").html(getModal);
        })
    });
