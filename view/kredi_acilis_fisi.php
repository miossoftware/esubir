...
<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>KREDİ AÇILIŞ FİŞLERİ</div>
    </div>
    <div class="col-12 row">
        <div class="mx-2">
            <button class="btn btn-success btn-sm" id="kredi_acilisi_yap_button"><i class="fa fa-plus"></i> Yeni Kredi
                Ekle
            </button>
        </div>
        <div class="col-12 row">
...
<script>
    $(document).ready(function () {
        ...
        $.get("controller/kredi_controller/sql.php?islem=acilis_kredilerini_getir_sql", function (res) {
            if (res != 2) {
    ...
    $("body").off("click", "#kredi_acilisi_yap_button").on("click", "#kredi_acilisi_yap_button", function () {
        $.get("modals/kredi_modal/kredi_acilis_modal.php?islem=yeni_kredi_kullan_modal", function (getModal) {
