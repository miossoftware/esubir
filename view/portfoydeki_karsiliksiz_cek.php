<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>PORTFÖYDEKİ KARŞILIKSIZ ÇEKLER</div>
    </div>
    <div class="col-12 row">
        <div class="mx-2">
            <button class="btn btn-success btn-sm" id="portfoydeki_cekleri_getir"><i class="fa fa-plus"></i>
...
<script>
    ...
    $(document).ready(function (){
        ...
        $.get("controller/cek_senet_controller/sql.php?islem=karsiliksiz_portfoydeki_verilen_cekleri_getir", function (result) {
            if (result != 2) {
                ...
                json.forEach(function (item) {
                    ...
                    let newRecord = {
                        ...
                        'button':"<button class='btn btn-danger btn-sm portfoydeki_karsiliksiz_ceki_iptal_et_sql' data-id='"+item.id+"'><i class='fa fa-trash'></i></button>",
                    };
    ...
    $("body").off("click",".portfoydeki_karsiliksiz_ceki_iptal_et_sql").on("click",".portfoydeki_karsiliksiz_ceki_iptal_et_sql",function (){
        ...
        if (id == "" || id == undefined) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "controller/cek_senet_controller/sql.php?islem=portfoydeki_karsiliksiz_cek_iptal_et_sql",
                        type: "POST",
                        data: {
                            id: id,
    ...
    $("body").off("click","#portfoydeki_cekleri_getir").on("click","#portfoydeki_cekleri_getir",function (){
        $.get("modals/karsiliksiz_cek_modal/modal.php?islem=portfoydeki_cek_karsiliksiz",function (getModal){
            $(".getModals").html("");
