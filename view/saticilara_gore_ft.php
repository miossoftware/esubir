...
<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>SATICILARA GÖRE FATURA LİSTESİ</div>
    </div>
    ...
    $(document).ready(function () {
        ...
        var table = $('#alis_fatura_table').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: "SATICILARA GÖRE FATURA LİSTESİ",
        ...
        $("body").off("click", "#saticilara_gore_fatura_filtrele").on("click", "#saticilara_gore_fatura_filtrele", function () {
            ...
            $.get("controller/alis_controller/sql.php?islem=saticilara_gore_fatura_listesi_sql", {
                bas_tarih: bas_tarih,
                bit_tarih: bit_tarih,
        ...
        $.get("controller/alis_controller/sql.php?islem=saticilara_gore_fatura_listesi_sql", function (res) {
            if (res != 2) {
                var json = JSON.parse(res);
                table.rows.add(json).draw(false);
                let gbp = "";
