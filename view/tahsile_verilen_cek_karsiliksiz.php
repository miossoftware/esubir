<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>TAHSİLE VERİLEN KARŞILIKSIZ ÇEKLER</div>
    </div>
    <div class="col-12 row">
        <div class="mx-2">
            <button class="btn btn-success btn-sm" id="tahsile_verilen_cek_ve_senetler"><i class="fa fa-plus"></i>
...
<script>
    ...
    $(document).ready(function (){
        ...
        $.get("controller/cek_senet_controller/sql.php?islem=karsiliksiz_tahsile_verilen_cekleri_getir", function (result) {
            if (result != 2) {
                ...
                json.forEach(function (item) {
                    ...
                    let newRecord = {
                        ...
                        'button':"<button class='btn btn-danger btn-sm karsiliksiz_tahsil_cek_senet_iptal_main' data-id='"+item.id+"'><i class='fa fa-trash'></i></button>",
                    };
    ...
    $("body").off("click",".karsiliksiz_tahsil_cek_senet_iptal_main").on("click",".karsiliksiz_tahsil_cek_senet_iptal_main",function (){
    ...
    $("body").off("click","#tahsile_verilen_cek_ve_senetler").on("click","#tahsile_verilen_cek_ve_senetler",function (){
        $.get("modals/karsiliksiz_cek_modal/modal.php?islem=tahsilata_verilen_cekleri_getir_modal",function (getModal){
            $(".getModals").html("");
