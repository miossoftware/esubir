...
<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>ÜYE BORÇ ALACAK DURUM RAPORU</div>
    </div>
    <div class="col-12 row no-gutters">
        ...
        <div class="col-1 mx-2">
            <button class="btn btn-secondary btn-sm" id="uye_borc_alacak_filtrele"><i class="fa fa-filter"></i> Hazırla
            </button>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("controller/uye_controller/sql.php?islem=uye_borc_alacak_durumu_filtrele",
            {
        ...
        $("body").off("click", "#uye_borc_alacak_filtrele").on("click", "#uye_borc_alacak_filtrele", function () {
