<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>VERİLEN ÇEK RAPORLARI</div>
    </div>
    <div class="col-12 row">
        <div class="col-12 row mx-1 mt-3">
            ...
            <div class="col-md-2 row mx-1">
                ...
                <button class="btn btn-info btn-sm" id="verilen_cek_ve_senet_filtrele"><i
...
<script>
    $(document).ready(function () {
        ...
        $.get("controller/cek_senet_controller/sql.php?islem=verilen_cek_raporlari_sql", function (res) {
            if (res != 2) {
        ...
        $("body").off("click", "#verilen_cek_ve_senet_filtrele").on("click", "#verilen_cek_ve_senet_filtrele", function () {
            let bas_tarih = $("#bas_tarih").val();
            let bit_tarih = $("#bit_tarih").val();
            let cari_adi = $("#cari_adi").val();


            $.get("controller/cek_senet_controller/sql.php?islem=verilen_cek_raporlari_sql", {
                bas_tarih: bas_tarih,
                bit_tarih: bit_tarih,
                cari_adi: cari_adi
            }, function (res) {
