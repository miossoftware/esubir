...
<div class="ibox mt-5">
    <div class="ibox-head">
        <div class="ibox-title" style=' font-weight:bold;'>VERİLEN SİPARİŞLER</div>
    </div>
    <div class="col-md-12 row">
        <div class="verilen_siparis_buttons mx-2 mt-3">
            <button class="btn btn-success btn-sm" id="yeni_siparis_olustur_main"><i class="fa fa-plus"></i> Sipariş
                Oluştur
            </button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("body").off("click", "#siparis_filtrele").on("click", "#siparis_filtrele", function () {
            ...
            if (bas_tarih > bit_tarih) {
                ...
                $.get("controller/alis_controller/sql.php?islem=siparis_filtrele_main", {
                    bas_tarih: bas_tarih,
                    bit_tarih: bit_tarih,
        ...
        $.get("controller/alis_controller/sql.php?islem=verilen_siparisleri_getir_sql", function (result) {
            if (result != 2) {
                var toplam_tutar = 0;
                var toplam_siparis = 0;
                var json = JSON.parse(result);
    ...
    $("body").off("click", ".siparis_duzenle_button").on("click", ".siparis_duzenle_button", function () {
        ...
        $.get("modals/alis_modal/siparis_page.php?islem=siparis_guncelle_modal_getir", {id: id}, function (getModal) {
            $(".getModals").html("");
        ...
        if (id == "" || id == undefined) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "controller/alis_controller/sql.php?islem=siparis_iptal_sql",
                        type: "POST",
                        data: {
                            id: id,
        ...
        if (id == "" || id == undefined) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const delete_detail = result.value;
                    $.ajax({
                        url: "controller/alis_controller/sql.php?islem=siparis_sil_sql",
                        type: "POST",
                        data: {
                            id: id,
                            delete_detail: delete_detail
    ...
    $("body").off("click", "#yeni_siparis_olustur_main").on("click", "#yeni_siparis_olustur_main", function () {
        $.get("modals/alis_modal/siparis_modal.php?islem=yeni_siparis_olustur", function (getModal) {
            $(".getModals").html("");
            $(".getModals").html(getModal);
        })
    });
